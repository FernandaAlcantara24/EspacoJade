...
export const Items =[
    ...
    },
    {
        id:9,
        category:'Conjunto',
        productName:'Conjunto Flowers',
        productPrice:'79,90',
        description: 'O Conjunto Flowers é uma escolha aconchegante e elegante para os dias mais frescos. Composto por peças coordenadas em tons terrosos e texturas quentes, como blusa e calça ou saia, proporciona conforto e estilo durante a estação. Versátil, pode ser usado em diversas ocasiões, do trabalho a eventos casuais. Combine com botas e acessórios para um look completo que celebra a beleza do outono.',
        image: require('../../assets/conjuntoCroppedeSaia.png'),
        colors:  [ '#E0F4FF','#074173', '#D20062','#FCDC2A'],
        material:'Viscolinho',
        type: 'conjunto',
    },
    {
        id:10,
        category:'Macacão',
        productName:'Macacão Folhagem',
        productPrice:'90,00',
        description: 'Este macacão evoca uma sensação de leveza e beleza natural, perfeito para um dia ensolarado ou uma noite estrelada.',
        image: require('../../assets/macacaoSombradeFolhagem.png'),
        colors:  [ '#074173', '#FCDC2A','#D20062','#000000'],
        material:'Viscolinho',
        type: 'macacão',
    },
]